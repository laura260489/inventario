...
<div class="row" style="margin-right: 2%">
  ...
  <div class="col-md-4">
      ...
      <?php
        ...
        $consulta="SELECT COUNT(computador_mesa_inventario.computador_mesa_inventario_id) AS total_objeto FROM computador_mesa_inventario INNER JOIN inventario ON computador_mesa_inventario.computador_mesa_inventario_inventario_id=inventario.inventario_id INNER JOIN sede_corhuila ON inventario.inventario_sede_id=sede_corhuila.sede_corhuila_id WHERE computador_mesa_inventario.computador_mesa_inventario_estado LIKE 'activo%' AND sede_corhuila.sede_corhuila_nombre='Quirinal';";
        $result = $mysqli->query($consulta);
  ...
  <div class="col-md-4">
      <?php
        ...
        $consulta_dos="SELECT COUNT(computador_mesa_inventario.computador_mesa_inventario_id) AS total_objeto FROM computador_mesa_inventario INNER JOIN inventario ON computador_mesa_inventario.computador_mesa_inventario_inventario_id=inventario.inventario_id INNER JOIN sede_corhuila ON inventario.inventario_sede_id=sede_corhuila.sede_corhuila_id WHERE computador_mesa_inventario.computador_mesa_inventario_estado LIKE 'activo%' AND sede_corhuila.sede_corhuila_nombre='Prado Alto';";
...
<script src="js/busqueda_cm.js"></script>
