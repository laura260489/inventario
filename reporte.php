      ...
      <table id="tableReporte" class="table table-striped">
        ...
        <tbody>
          ...
          <?php
            ...
            $consulta="SELECT COUNT(objeto.objeto_id) AS total_objeto, dependencia.dependencia_nombre AS Dependencia, objeto.objeto_nombre AS Equipo FROM registro_objeto INNER JOIN inventario ON registro_objeto.registro_objeto_inventario=inventario.inventario_id INNER JOIN dependencia ON inventario.inventario_dependencia=dependencia.dependencia_id INNER JOIN colaborador ON colaborador.colaborador_dependencia=dependencia.dependencia_id INNER JOIN objeto ON inventario.inventario_objeto_id=objeto.objeto_id INNER JOIN sede_corhuila ON inventario.inventario_sede_id=sede_corhuila.sede_corhuila_id GROUP BY objeto.objeto_nombre;";
