...
<body>
            ...
            <div class="col-md-12">
                <ul class="list-group list-group-flush">
                    ...
                    require_once 'php/conexion.php';
                        ...
                        $query="SELECT computador_mesa.computador_mesa_procesador AS procesador, computador_mesa.computador_mesa_modelo AS modelo, computador_mesa.computador_mesa_ram AS RAM, computador_mesa.computador_mesa_velocidad AS Disco FROM computador_mesa WHERE computador_mesa.computador_mesa_placa='".mysqli_real_escape_string($mysqli,$id)."' LIMIT 1";
                        ...
                        $query_dos="SELECT computador_mesa.computador_mesa_id FROM computador_mesa WHERE computador_mesa.computador_mesa_placa='".mysqli_real_escape_string($mysqli,$id)."'";
                        $result_dos = $mysqli->query($query_dos);

                        while($row_dos=$result_dos->fetch_array(MYSQLI_ASSOC)){
                            
                            $computador_mesa_id=$row_dos['computador_mesa_id'];
                        }

                        $_SESSION['computador_mesa_id']=$computador_mesa_id;
    ...
    <script src="js/transferir_cm.js"></script>
</body>
</html>